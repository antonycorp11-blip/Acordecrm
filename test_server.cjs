...
async function test() {
    try {
        const reqBody = {
            ...
            curso_id: 1, // assume 1
            professor_id: 1, // assume 1
            dia_semana: '2026-06-12',
            horario: '16:00',
            pacote_id: 1, // assume 1
            valor_parcela: '150',
        ...
        if (errAulas) { console.error("ErrAulas", errAulas); throw errAulas; }
        ...
        if (errPagamentos) { console.error("ErrPagamentos", errPagamentos); throw errPagamentos; }
