...
const student = {
  migracao_id: "39b86199-4ea7-4dfa-83b2-8932f5cd1cf7",
  nome: "WILSON FERREIRA DINIZ NETO",
  email: "mariaterezadepinhodearruda@gmail.com",
  telefone: "",
  cpf: null,
  endereco: "Rua Vinte e Um, 07 Pedra 90 78099105 - Cuiabá - MT",
  data_nascimento: parseBirthDate("23/02/2013"),
  responsavel_nome: "Maria Tereza de Pinho de Arruda",
  responsavel_telefone: "(65) 99205-4401",
  responsavel_cpf: "621.709.371-53",
  curso_id: 4, // Bateria
