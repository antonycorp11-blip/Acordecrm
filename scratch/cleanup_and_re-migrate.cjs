...
const studentsToReMigrate = [
  {
    ...
    dia_semana: 6, // Sábado
    horario: "11:00",
    pacote_id: 2, // Semestral (Corrigido para 2!)
    aulas_restantes: 14,
    reposicoes: 0,
    faturas_pendentes: 2,
    faturas_atrasadas: 0,
  ...
  },
  {
    ...
    curso_id: 3, // Teclado
    professor_id: 2, // Juan Henrique (Corrigido para 2!)
...
async function main() {
  console.log("=== LIMPANDO ALUNOS ÓRFÃOS ===");
  // Remover os alunos órfãos
  await supabase.from('alunos').delete().in('id', [4213, 4214]);
  console.log("[+] Limpeza concluída!");

  // Re-migrar os alunos
  for (const student of studentsToReMigrate) {
